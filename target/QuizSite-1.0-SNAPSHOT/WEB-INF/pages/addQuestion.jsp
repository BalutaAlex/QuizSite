    ...
    <div class="container">
        <div id="addQuestion" class="flex-column flex-center">
            <form  method="POST" action="${pageContext.request.contextPath}/AddNewQuestionServlet" class="add-newQuestion-form">
                ...
                <input type="text" name="question"  placeholder="Introduceti intrebarea" autofocus>
                <input type="text" name="answer1"  placeholder="Raspunsul A">
                <input type="text" name="answer2"  placeholder="Raspunsul B">
                <input type="text" name="answer3"  placeholder="Raspunsul C">
                <input type="text" name="answer4"  placeholder="Raspunsul D">
                ...
                <button class="btn" type="submit" name="newQuestionBtn">Adauga</button>
